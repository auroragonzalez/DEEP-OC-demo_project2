...
# For CPU:
# "docker_image": "auroragonzalez/deep-oc-demo_project2:latest",
# "num_gpus": "0",
# ## run_command options: ##
...
###
# For GPU:
# "docker_image": "auroragonzalez/deep-oc-demo_project2:gpu",
# "num_gpus": "1",
# ## run_command options: ##
...
#
orchent depcreate $topology_file '{ "docker_image": "auroragonzalez/deep-oc-demo_project2:latest",
                                    "mem_size": "8192 MB",
                                    "num_cpus": "1",
                                    "num_gpus": "0",
